...
public var joystickCircleToWriteOutput : JoystickCircle;
public var joystickCircleToWriteOutput2 : JoystickCircle;
...
function OnGUI () {
	...
	if(joystickCircleToWriteOutput2){
			GUI.Label (Rect (Screen.width * 0.35, Screen.height * 0.80, Screen.width * 0.6, Screen.height * 0.1), String.Format("(Left) Angle (in Degree) =  {0:F2} ", joystickCircleToWriteOutput2.outputAngleRad * Mathf.Rad2Deg));
		GUI.Label (Rect (Screen.width * 0.8, Screen.height * 0.80, Screen.width * 0.2, Screen.height * 0.1), String.Format("Force =  {0:F2}", joystickCircleToWriteOutput2.outputForce));
	}
