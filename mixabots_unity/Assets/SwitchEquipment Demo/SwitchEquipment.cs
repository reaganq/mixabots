...
public class SwitchEquipment : MonoBehaviour 
{
	...
	private string txt = "Press space to put it on.";	
	...
	{
		if( shorty == null )
			shorty = GameObject.Find( "Short_full_skeleton" );
	}
	...
	{
		isWorn = true;
		txt = "Press space to take it off.";
	...
	private void OnGUI()
	{
		GUI.Label ( new Rect( 10f, 10f, Screen.width - 20f, 50f ), txt );
	}
}
